...
AirTunesDevice.prototype.relayAudio = function() {
  ...
  this.audioCallback = function(packet) {
    var airTunes = makeAirTunesPacket(packet, self.encoder, self.requireEncryption, self.alacEncoding, self.bindings, self.bindingsok);
...
function makeAirTunesPacket(packet, encoder, requireEncryption, alacEncoding = true, bindings, bindingsok) {
