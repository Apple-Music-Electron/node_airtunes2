...
ws.on('open', function open() {
  ws.send(JSON.stringify({"type":"addDevices",
      ...
      //  "password":"853228",
       ...
       // txt: ["acl=0","deviceid=38:42:0B:92:76:C0","features=0x445F8A00,0x1C340","rsf=0x0","fv=p20.72.2-40060","flags=0x4","model=Bookshelf","manufacturer=Sonos","serialNumber=nol","protovers=1.1","srcvers=366.0","pi=nol","gid=nol","gcgl=0","pk=lolno"],
